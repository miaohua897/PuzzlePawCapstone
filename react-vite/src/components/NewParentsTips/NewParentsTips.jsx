...
function NewParentsTips(){
    ...
    const [tips, setTips] = useState([
        ...
        {id:5,top:'No. 5 : Dogs love to chew, so providing safe toys and chews can help redirect this natural behavior and keep them from damaging furniture or other household items.'}
    ])
