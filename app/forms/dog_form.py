...
class DogForm(FlaskForm):
    ...
    owner_address_line_two = StringField('owner_address_line_one', validators=[DataRequired()])    
    ...
    owner_address_country = StringField('owner_address_country', validators=[DataRequired()])